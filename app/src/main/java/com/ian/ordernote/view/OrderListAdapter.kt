...
class OrderListAdapter(val context: Context, var orderList: ArrayList<OrderInfo>, val listener: OrderListActivity.OrderInfoListener) : BaseAdapter() {
