...
class CustomerListAdapter(val context: Context, var customerList: ArrayList<CustomerInfo>, val listener: CustomerListActivity.CustomerChangeListener) : BaseAdapter() {
